...
export default function Home() {
  return (
    <div
      className="md:h-[735px] h-auto w-[90%] flex items-center flex-col text-white scroll-smooth"
      id="data"
    >
      ...
      <div className="w-[90%] h-[175px] bg-data2 md:hidden rounded-[24px] border-[#7C7E7E] font-normal border-[1px] flex items-center flex-col">
        ...
        <div className="w-[70%] text-[22px] text-center mt-[30px]">
          Data Lakehouse Warehouse
        </div>
      </div>
      ...
      <div className="w-[90%] h-[175px] bg-data2 md:hidden rounded-[24px] border-[#7C7E7E] font-normal border-[1px] flex items-center flex-col">
        ...
        <div className="w-[70%] text-[22px] text-center mt-[45px]">
          Data Integration
        </div>
      </div>
      <div className="w-[3px] h-[94px] bg-data3 block md:hidden "></div>
