      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 h-full">
        <div className="flex justify-between h-full items-center">
          ...
          <div className="hidden md:flex h-full w-[30%]">
            <a
              href="#"
              className="text-gray-400 hover:text-white hover:font-semibold duration-200 h-full font-light flex justify-center items-center w-[25%]"
              onClick={(e) => {
                e.preventDefault();
                scrollToSection("#top");
              }}
            ...
            <a
              href="#"
              className="text-gray-400 hover:text-white hover:font-semibold duration-200 h-full font-light flex justify-center items-center w-[30%]"
              onClick={(e) => {
                e.preventDefault();
            ...
            <a
              href="#"
              className="text-gray-400 hover:text-white hover:font-semibold duration-200 h-full font-light flex justify-center items-center w-[50%]"
              onClick={(e) => {
                e.preventDefault();
          ...
          <div className="hidden md:flex">
            <a
              href="#"
              className="flex items-center space-x-2 rounded-xl border-2 text-white font-medium text-sm px-4 py-2 text-center bg-transparent border-[#EF5239]"
              onClick={(e) => {
                e.preventDefault();
